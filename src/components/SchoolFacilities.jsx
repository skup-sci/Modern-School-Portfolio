...
const SchoolFacilities = () => {
  ...
  const facilityList = [
    ...
    },
    {
      ...
      description: {
        en: 'Comfortable and secure hostel facility for students from distant locations.',
        hi: 'दूरस्थ स्थानों से आने वाले छात्रों के लिए आरामदायक और सुरक्षित छात्रावास सुविधा।'
      },
      highlights: [
        {
          en: 'Separate blocks for girls',
          hi: 'लड़कियों के लिए अलग ब्लॉक'
        },
        {
          en: 'Hygienic mess facilities',
          hi: 'स्वच्छ मेस सुविधाएं'
        },
        {
          en: '24-hour security',
          hi: '24 घंटे सुरक्षा'
    ...
    },
    {
      ...
      description: {
        en: 'Modern auditorium for cultural events, assemblies and important functions.',
        hi: 'सांस्कृतिक कार्यक्रमों, सभाओं और महत्वपूर्ण समारोहों के लिए आधुनिक सभागार।'
      },
      highlights: [
        {
          en: 'Capacity of 500 people',
          hi: '500 लोगों की क्षमता'
        },
        {
          en: 'Advanced sound system',
          hi: 'उन्नत ध्वनि प्रणाली'
        },
        {
          en: 'Modern stage setup',
          hi: 'आधुनिक मंच व्यवस्था'
        }
      ]
    },
  ];
  ...
  const handleFacilityClick = (id) => {
    ...
    <div className="w-full bg-white rounded-lg shadow-lg p-4 sm:p-6 border border-amber-100">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">        <h2 className="text-xl sm:text-2xl font-bold text-amber-700 pb-2 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        {facilityList.slice(0, 6).map((facility, index) => (
          ...
          >
            <div className="p-3 cursor-pointer flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-sm">
                ...
                {/* Always render the content div but control visibility with CSS */}
                <div 
                  className={`mt-3 pt-3 border-t border-amber-200 w-full transition-all duration-300 overflow-hidden ${
                    expandedFacility === facility.id 
                      ? 'max-h-96 opacity-100 animate-fadeIn' 
